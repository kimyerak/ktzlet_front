...
OX 문제 예시:
- 올바른 형식: "battery : 배터리" (correctAnswer: 1, O)
- 잘못된 형식: "apple : 바나나" (correctAnswer: 0, X)
- 잘못된 형식: "배터리 : 카메라" (한국어:한국어 - 절대 사용 금지)
- 잘못된 형식: "battery : battery" (중복 - 절대 사용 금지)

OX 문제 규칙:
- stem은 반드시 "영어단어 : 한국어뜻" 형식이어야 합니다.
- 영어 부분에는 반드시 영어 단어만 사용하세요 (예: "bibimbap", "jeon", "kimchi").
- 한국어 부분에는 반드시 한국어 뜻만 사용하세요 (예: "비빔밥", "전", "김치").
- 절대 "전은 한국의 전통 음식 중 하나이다" 같은 문장 형식을 사용하지 마세요.
- 절대 "비빔밥의 실제 영어 단어는?" 같은 질문 형식을 사용하지 마세요.
- 절대 "배터리 : 카메라" 같은 한국어:한국어 형식을 사용하지 마세요.
- 절대 "인구 : 인구" 같은 중복 형식을 사용하지 마세요.
- 영어 단어는 반드시 영어 알파벳으로만 구성되어야 합니다.
- OX 문제는 반드시 "단어 : 뜻" 매칭 형식이어야 합니다.
